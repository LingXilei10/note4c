...
![ink-image](E:/076lxl/work/labuladong-fucking-algorithm/pictures/单调栈/1.png)
...
这个算法的时间复杂度不是那么直观，如果你看到 for 循环嵌套 while 循环，可能认为这个算法的复杂度也是 O(n^2)，但是**实际上这个算法的复杂度只有 O(n)**。
...
![ink-image](E:/076lxl/work/labuladong-fucking-algorithm/pictures/单调栈/2.png)
...
![ink-image (E:/076lxl/work/labuladong-fucking-algorithm/pictures/单调栈/3.png)](../pictures/%E5%8D%95%E8%B0%83%E6%A0%88/3.png)
